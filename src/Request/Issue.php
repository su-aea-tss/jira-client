...
use SUTSS\JiraClient\JiraClient,
    ...
    SUTSS\JiraClient\Resource\Field,
    SUTSS\JiraClient\Resource\AbstractResource,
    SUTSS\JiraClient\Resource\ResourcesList,
    SUTSS\JiraClient\Resource\FieldMetadata,
    SUTSS\JiraClient\Resource\Comment,
    SUTSS\JiraClient\Resource\FluentIssueCreate,
    SUTSS\JiraClient\Resource\Worklog;
...
class Issue extends AbstractRequest
{
     ...
     * @param string $projectKey
     * @param string $issueTypeName
     * @return \SUTSS\JiraClient\Resource\FieldMetadata[]
     * @throws JiraException
     */
     ...
     *
     * @param type $issue
     * @return \SUTSS\JiraClient\Resource\FluentIssueTransition
     */
    public function transition($issue)
    {
        return new \SUTSS\JiraClient\Resource\FluentIssueTransition($issue);
    }
     ...
     * @param type $expandFields
     * @return \SUTSS\JiraClient\Resource\Issue
     */
    public function get($issue, $includedFields = null, $expandFields = false)
    {
        ...
        return new \SUTSS\JiraClient\Resource\Issue($this->client, $result);
    }
